...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function myInput($type, $name, $label = '', $options = [], $default = null)
        {
         ...
         * @static 
         */ 
        public static function mySelect($name, $label = '', $values = [], $selected = null, $options = [])
        {
         ...
         * @static 
         */ 
        public static function myFile($name, $label = '', $options = [])
        {
         ...
         * @static 
         */ 
        public static function myTextArea($name, $label = '', $options = [], $default = null)
        {
         ...
         * @static 
         */ 
        public static function myCheckbox($name, $label = '', $value = '', $checked = false, $options = [])
        {
         ...
         * @static 
         */ 
        public static function myRange($name, $start, $end, $selected = '', $options = [])
        {
